...
var app = new Vue({
  ...
  methods: {
    searchRestaurantFunction: function searchRestaurantFunction() {
      var _this2 = this;

      this.searchRestaurant = [];
      this.restaurants.forEach(function (restaurant) {
        if (restaurant.name.toLowerCase().includes(_this2.search.toLowerCase())) {
...
module.exports = __webpack_require__(/*! /Users/veronica/laravel-projects/deliveboo-team3/resources/js/restaurants.js */"./resources/js/restaurants.js");
