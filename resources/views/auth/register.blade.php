                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="net_number" type="text" class="form-control @error('net_number') is-invalid @enderror" name="net_number" value="{{ old('net_number') }}" required autocomplete="net_number">
